    ...
    <div class="wrap-addTask">
        ...
        <main>
            <div class="main-addTask">
                <div class="taskSum">
                    <form method="POST">
                        Your text:<br> <textarea name="string" placeholder="Tap here your string"></textarea><br> <br>
                        <input type="submit" class="submit" name="submit" value="Get result"> <br> <br> <br>
                        Result: <br> <textarea placeholder="Here will be the result" name="resultString"
                            readonly><?php require_once("regularExp.php");?></textarea><br>
                    </form>
                </div>
                <div class="animate">
